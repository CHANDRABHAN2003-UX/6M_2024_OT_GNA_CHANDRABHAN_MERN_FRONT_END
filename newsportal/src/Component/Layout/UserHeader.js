...
export default function UserHeader() {
    ...
    useEffect(() => {
        ...
        if (!token && window.location.pathname !== "/login" && window.location.pathname !== "/register") {
          nav("/login"); // If no token and not on login or register page, redirect to login page
        }
      }, [nav]);
              ...
              <div className="row align-items-center">
                <div className="col-xl-10 col-lg-10 col-md-12">
                  ...
                  <nav className="main-menu d-flex justify-content-between">
                    <ul
                      id="navigation"
                      className="d-flex list-unstyled gap-4 mb-0"
                    >
                      ...
                      <li>
                        <Link to="/newsidea">NewsIdea</Link>
                      </li>
                      <li>
                      ...
                      {isLoggedIn && (
                        <Link onClick={logout} className="btn btn-primary px-3 d-none d-sm-block mx-auto mt-3 ">
